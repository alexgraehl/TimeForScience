...
#	    fi ;; ## <-- Done with the "multi-part archive" part
  ...
  #  UNIX-tool-only version of this, instead of "sheet.pl", use "column -t -s '	'"
	...
	*.bai) echo "******** NOT THE ACTUAL CONTENTS OF THE FILE *********" ;
	       echo "******** This file (<$1>) is a .bai index file (in a binary format), so we are not displaying it." ;
	       echo "******** This message was generated by the 'lesspipe_advanced.sh' script, which is used by 'less'.";
