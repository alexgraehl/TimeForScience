...
export PATH=$(deduped "${HOME}/bin:${HOME}/.local/bin:${HOME}/.linuxbrew/bin:${TIME_FOR_SCIENCE_DIR}/Lab_Code/Perl:${TIME_FOR_SCIENCE_DIR}/Lab_Code/Python:${TIME_FOR_SCIENCE_DIR}/Lab_Code/Python2:${TIME_FOR_SCIENCE_DIR}/Lab_Code/Python3:${TIME_FOR_SCIENCE_DIR}/Lab_Code/Shell:${TIME_FOR_SCIENCE_DIR}/Lab_Code/R:${PATH}:${BINF_CORE_WORK_DIR}/Code/Python:${MINICONDA_BIN}:${HOME}/workspace/0_CODE/programs")   # <-- PRIORITY: programs in your own home directory come FIRST, then System-wide "Science" bin, then other stuff.
