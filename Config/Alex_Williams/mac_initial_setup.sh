...
# Set sidebar icon size to medium = 2, small = 1
...
# Alex's note: *actually requires you to re-plug-in your keyboard after changing!* Does not take effect until you unplug the USB keyboard!
# You're setting the KeyRepeat rate to 1 (15ms). The default minumum is 2 (30ms).)
...
# Folders on top is "true" / default is "false"
...
# *DO* (true) group windows by application in Mission Control
