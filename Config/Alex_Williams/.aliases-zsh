...
alias -g invisible='chflags -h hidden'  #alias invisible='chflags hidden' #$SETFILE_LOCATION -P -a V' ## Mac-only: Make a file/folder invisible to the Finder
alias -g visible='chflags -h nohidden' #alias visible='chflags nohidden' #$SETFILE_LOCATION -P -a v' ## Mac-only: opposite of "invisible"
alias -g lock='chflags uchg'     # Mac: lock file
alias -g unlock='chflags nouchg' # Mac: unlock file

alias -g clearicon='$SETFILE_LOCATION -P -a c' ## clear mac custom icons. Useful for images that have old custom icons.
alias -g version="lsb_release -a" # Tells you which version of Ubuntu you are running!
alias -g vscode="code"
alias -g vs="vscode"

alias -g wcl='grep -c ""' # actually gives you the NUMBER and not the filename
alias -g sortt='sort -t "	"' # sort with tab as separator
alias -g sortg='sort -g -t "	"' # sort NUMBERS, with tab as separator
alias -g e="emacs -nw"
alias -g gitours="git checkout --ours"
alias -g gitcom="git commit -a -m 'Changes committed by ${USER}'"
alias -g git-list="git ls-tree -r master --name-only" # show currently tracked files
alias -g gits="git status"
alias -g git-stat="git ls-files --modified --deleted"
alias -g git-diff="git difftool"
alias -g s="less -S --LINE-NUMBERS --status-column"
alias -g res="source $HOME/.zshrc"
