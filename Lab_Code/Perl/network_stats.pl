...
use lib "$ENV{MYPERLDIR}/lib"; use lib "$ENV{TIME_FOR_SCIENCE_DIR}/Lab_Code/Perl"; require "libstats.pl"; # Note that this defines "max" and "min" as vector operations! This overloads the ones found in List::Util
