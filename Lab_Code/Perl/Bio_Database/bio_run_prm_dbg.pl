...
use lib "$ENV{MYPERLDIR}/lib"; use lib "$ENV{TIME_FOR_SCIENCE_DIR}/Lab_Code/Perl"; require "time.pl";
...
{
  log_conditional_execute("bio_run_prm_observed_dbg.pl $settings_file $iteration", $run_prm_observed);

  log_conditional_execute("bio_run_prm_hidden_dbg.pl $settings_file $iteration", $run_prm_hidden);
