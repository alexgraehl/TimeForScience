...
#@COMMENT@ sort.pl is a modified version of UNIX sort that can handle a header line. It just passes things through to 'sort' otherwise. Frequency-of-use rating: 9/10.
