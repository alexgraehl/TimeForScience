...
## Usage:  ./randomize.pl -cycle   or randomize.pl -generate 1
...
} elsif ($ARGV[0] eq '-cycle') {
    # cycle through the colors
    
    my $prefFile = $ENV{'HOME'} . '/' . '.rand_term_color_setting';
    my $termCount = 0;
...
#print STDOUT "tell application \"Terminal\"
