...
knitr::opts_chunk$set(dev='png', fig.align='center', fig.width=8, fig.height=5, out.width='2000px', fig.pos='htbp', error=FALSE, warn=TRUE, echo=FALSE, results='hide', cache=FALSE, message=FALSE)
...
```{r, results='asis', echo=F, message=TRUE, cache=FALSE, fig.width=8, fig.height=10}
