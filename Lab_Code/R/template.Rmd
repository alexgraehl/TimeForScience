...
author: "___________________Author__________________________________"
...
<<<<<<< HEAD
```{r setup, include=FALSE} # include=FALSE --> evaluated, but neither the code nor its output displayed.
=======
```{r setup, include=FALSE}
# include=FALSE --> evaluated, but neither the code nor its output displayed.
>>>>>>> 8353a35b23875b2d23ddddd05ae2e58abd2d7fcf
