...
knitr::opts_chunk$set(dev='png', fig.align='center', fig.width=8, fig.height=5, out.width='2000px', fig.pos='htbp', echo=FALSE, results='hide', cache=FALSE, message=FALSE)
...
```{r , results='asis', echo=F, error=TRUE, message=TRUE, warning=TRUE, cache=FALSE, fig.width=8, fig.height=10}
